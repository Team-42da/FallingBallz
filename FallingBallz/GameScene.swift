...
class GameScene: SKScene {
    ...
    func makeObstacle() {
        ...
        let obstaclePadding = SKPhysicsBody(rectangleOf: CGSize(width: obstacle.size.width+30, height: obstacle.size.height+20))
        obstaclePadding.affectedByGravity = false
        //body.usesPreciseCollisionDetection = true  //충돌감지할 때 사용
